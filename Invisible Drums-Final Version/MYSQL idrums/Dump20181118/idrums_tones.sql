...
--
-- Host: localhost    Database: idrums
-- ------------------------------------------------------
...
CREATE TABLE `tones` (
  ...
  `LinktoTone` varchar(200) NOT NULL,
  `BinaryofTone` mediumblob NOT NULL,
  PRIMARY KEY (`ID`)
...
-- Dump completed on 2018-11-18 18:33:58
